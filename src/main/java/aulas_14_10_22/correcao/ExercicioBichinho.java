...
/*
* Exercícios: Encapsulamento, Abstração, Interação entre Objetos.

1) Com base nas classes criadas anteriormente tente aplicar private nos atributos e métodos necessários. Use getter e setter nos atributos que achar pertinente.
